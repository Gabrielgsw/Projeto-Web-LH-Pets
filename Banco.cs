...
namespace Projeto_Web_Lh_Pets_versão_1
{
	...
	public String GetListaString()//-> Faz as formatacoes html e recebe dados do banco 
	{
	...
	public void imprimirListaConsole(){ //-> so o programador tem acesso
